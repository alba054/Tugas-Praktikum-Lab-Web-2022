        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <tr>
                  ...
                  <td>
                  <a href="/category/edit/{{ $category->id }} "><button type="button" class="btn btn-warning">Edit</button></a>
                  <a href="/category/delete/{{ $category->id }} "><button type="button" class="btn btn-danger">Delete</button></a>
                  </td>
                </tr>
                @endforeach
