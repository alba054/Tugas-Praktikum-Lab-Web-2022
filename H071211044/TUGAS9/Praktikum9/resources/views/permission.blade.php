...
<div class="form-group">
  @csrf
            ...
            <input type="text" name="tdescriptions" value="" class="form-control" placeholder=" " required>
  ...
  <table class="table table-bordered table-striped">
        ...
        @foreach($data as $permission)
                <tr>
                  ...
                  <td><a href="/ps/edit/{{ $permission->id }}" type="button" class="btn btn-warning">EDIT</a>
                  <a href="/ps/delete/{{ $permission->id }}" type="button" class="btn btn-danger">DELETE</a></td>
                </tr>
                 @endforeach
