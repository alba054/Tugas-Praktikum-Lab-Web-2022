...
<div class="card">
  ...
  <div class="card-body">
    <form method="post" action="/s/edit/{{$data->id}}">
<div class="form-group">
  @csrf
            ...
            <label>Alamat</label>
            <input type="text" name="taddress" value="{{ $data->address}}" class="form-control" placeholder=" " required>
            ...
            <label>No.Hp</label>
            <input type="text" name="tnohp" value="{{ $data->no_hp}}" class="form-control" placeholder=" " required>
