...
if ($_POST) {
  ...
  $password = $_POST["password"];
    ...
    $database = mysqli_query($koneksi, "select * from users where email = '{$email}' ");
    // var_dump($database);
    // var_dump($database[0]);
    while($simpanData = mysqli_fetch_assoc($database)) $user = $simpanData;
...
<span class="close-btn">
  ...
  <form method="post" action="">
    <input type="email" name="email" placeholder="E-mail" id="staticEmail" value=""  >
    ...
    <!-- </div>
            <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? 
              <a href="/tugas7/register.php" class="link-danger">Register</a></p>
          </div> -->
  </form>
  <!-- </form> -->
  </div>
...
<div id="forgotten-container">
  ...
  <form>
    ...
    <center><a href="/tugas7/register.php" class="btn btn-success" type="submit">Sign Up</a></center> -->
