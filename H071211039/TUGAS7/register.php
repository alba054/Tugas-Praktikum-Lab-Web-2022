...
<head>
    ...
    <style>
      /* body {
          background-image: url("wp3272702--wallpapers.jpg");
    ...
    if ($_POST) {
        ...
        if ($name != "" && $email != "" && $password != "") {
            ...
            try {
                ...
                $database = mysqli_query($koneksi, "INSERT INTO users (email, password, name) VALUES ('{$email}','{$password}','{$name}')");
                header('Location: http://localhost/tugas7/login.php'); 
...
<section class="text-center">
  <!-- Background image -->
  <center><div class="p-5 bg-image" >  
        <img src="wp3272702--wallpapers.jpg" alt="bg" id="bgregis">
      </div></center>
  <!-- Background image -->
  <center><div class="cont justify-content-center card mx-4 mx-md-5 shadow-5-strong" style="
        margin-top: -170px;
      ...
      <div class="row d-flex justify-content-center">
        <div class="col-lg-8">
          ...
          <form>
            ...
            <center><p class="small fw-bold mt-2 pt-1 mb-0">Punya Akun? <a href="/tugas7/login.php"
                class="link-danger">Log In</a></p></center>
