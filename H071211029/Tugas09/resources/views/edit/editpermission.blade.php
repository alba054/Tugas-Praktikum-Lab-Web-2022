...
@section('data')
        <form action="/updatepermission/{{ $data->id }}" method="post">
            @csrf
            ...
            <div class="form-floating mb-4">
              <input name="desc" type="text" id="form3Example4" class="form-control @error('desc') is-invalid @enderror" value="{{ $data->desc }}"/>
