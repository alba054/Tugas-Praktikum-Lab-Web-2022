...
@section('data')
        <form action="/updateseller/{{ $data->id }}" method="post">
            @csrf
            ...
            <div class="form-floating mb-4">
              <input name="address" type="text" id="form3Example4" class="form-control @error('address') is-invalid @enderror" value="{{ $data->address }}"/>
            ...
            <div class="form-floating mb-4">
              <input name="no_hp" type="text" id="form3Example4" class="form-control @error('no_hp') is-invalid @enderror" value="{{ $data->no_hp }}"/>
