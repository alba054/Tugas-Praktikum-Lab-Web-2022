                                        ...
                                        <div class="small-box bg-light">
                                            <div class="inner">
                                             ...
                                             <div class="article-badge-item "><i class="fas fa-heart"></i> 555  </div>
                                                ...
                                                <!-- src="{{asset('kari.jpg')}}" -->
                                                <p> <b> {{ $makanan->name }} </b> </p>
                                                <p> {{ $makanan->description }} </p>
                                                <div class="info-box mb-6 bg-warning">
                                                  <span class="info-box-icon"><i class="fas fa-tag"></i></span>

                                                  <div class="info-box-content">
                                                    <span class="info-box-text">Harga : {{ $makanan->harga }}</span>
                                                  </div>

                                                  <!-- /.info-box-content -->
                                                </div>
                                                <a href="/mkn/edit/{{ $makanan->id }}" type="button" class="btn" data-toggle="modal" data-target="#modal-edit"><i class="fas fa-edit"></i> Edit</a></a>
                                                <a href="/mkn/delete/{{ $makanan->id }}" type="button" class="btn"><i class="fas fa-trash"></i> Delete</a></a>
...
<div class="modal fade" id="modal-edit">
        <div class="modal-dialog">
          <div class="modal-content ">
            ...
            <div class="form-group">
                    <label class="col-form-label" for="inputSuccess"><i class="fas "></i>Nama Makanan</label>
                  ...
                  <div class="form-group">
                    <label class="col-form-label" for="inputError"><i class="far"></i>Category</label>
                    <input type="text" class="form-control " id="inputError" placeholder="Enter ..." name="category">
                  </div>
                  <div class="form-group">
                    <label class="col-form-label" for="inputError"><i class="far"></i>Tag</label>
                    <input type="text" class="form-control " id="inputError" placeholder="Enter ..." name="tag" >
                  </div>
            </div>
