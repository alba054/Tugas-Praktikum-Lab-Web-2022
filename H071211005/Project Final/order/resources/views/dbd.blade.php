                ...
                <div class="row">
                    <section class="col-lg-12 connectedSortable">
                      ...
                      <div class="card">
                        ...
                        <h4>  Top 3 Makanan Terfavorit </h4>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <!-- small box -->
                                        <div class="small-box bg-light">
                                            <div class="inner">
                                                <img class="card-img-top" alt="" src="{{asset('dispuding.jpg')}}">
                                                <span class="badge text-bg-primary float-right"><div class="article-badge">
                                             <div class="article-badge-item "><i class="fas fa-shopping-cart"></i> 3333 </div>
                                            </div></span>
                                            <span class="badge text-bg-danger float-right"><div class="article-badge">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <!-- small box -->
                                        <div class="small-box bg-light">
                                            <div class="inner">
                                            <img class="card-img-top" src="{{asset('nasimc.jpg') }} " alt="">
                                            <span class="badge text-bg-primary float-right"><div class="article-badge">
                                             <div class="article-badge-item "><i class="fas fa-shopping-cart"></i> 3333 </div>
                                            </div></span>
                                            <span class="badge text-bg-danger float-right"><div class="article-badge">
                                    ...
                                    <div class="col-lg-4 col-6">
                                        ...
                                        <div class="small-box bg-light">
                                            <div class="inner">
                                            <img class="card-img-top" src="{{asset('app2.jpg') }} " alt="">
                                            <span class="badge text-bg-primary float-right"><div class="article-badge">
                                             <div class="article-badge-item "><i class="fas fa-shopping-cart"></i> 3333 </div>
                                            </div></span>
                                            <span class="badge text-bg-danger float-right"><div class="article-badge">
