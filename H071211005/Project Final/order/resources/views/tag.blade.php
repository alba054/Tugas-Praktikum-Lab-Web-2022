  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Muhammad Inzani
          </a>
        </div>
      </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="connectedSortable">
            <div class="container-fluid">
                        ...
                        <thead>
                             ...
                             <tbody>
                              ...
                              <td>
                                ...
                                <a href="/tag/delete/{{ $tag->id }}"  type="submit" class="btn btn-secondary "><i class="fas fa-trash"></i> Delete </a></a>
                ...
                <a href="" type="button" class="btn btn-warning float-right" data-toggle="modal" data-target="#modal-add"><i class="fas fa-plus"></i> Add Tag</a></a>
      ...
      <div class="modal fade" id="modal-add">
        ...
        <div class="modal-dialog">
          <div class="modal-content ">
            <div class="modal-header">
              <h4 class="modal-title">Tambah Data Tag</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body" >
            <div class="form-group">
                    <label class="col-form-label" for="inputSuccess"><i class="fas "></i>Nama Tag</label>
                    <input type="text" class="form-control is-valid" id="inputSuccess" placeholder="Enter ..." name="name">
                  </div>
                  <!-- <div class="form-group">
                    <label class="col-form-label" for="inputWarning"><i class="far "></i>Image</label>
